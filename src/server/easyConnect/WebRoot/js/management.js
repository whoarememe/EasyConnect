//下线处理函数
function logoutAjaxHandler (data, callback) {
	if (data.success == false) {
		if (data.message == 'login timeout') {
			alert('登录超时');
...
Vue.component('management-header', {
	methods: {
		logout: function () {
			$.ajax({
				url: '/EasyConnect/developer/developerLogut',
					...
					<div class='nav-header'>\
						...
						<nav id='fh5co-menu-wrap' role='navigation'>\
							<ul class='sf-menu' id='fh5co-primary-menu'>\
								...
								<li>\
									<a href='index.html' class='fh5co-sub-ddown'>我的后台</a>\
									 <ul class='fh5co-sub-menu'>\
									 	<li><a href='index.html'>设备管理</a></li>\
									 	<li><a href='personal.html'>个人信息</a></li>\
									</ul>\
								</li>\
								<li><a href='javascript:void(0);' v-on:click='logout'>注销</a></li>\
							</ul>\
						</nav>\
					</div>\
				</div>"
